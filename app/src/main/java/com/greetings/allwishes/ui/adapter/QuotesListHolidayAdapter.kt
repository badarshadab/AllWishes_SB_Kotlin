...
import com.greetings.allwishes.databinding.QoutesListHolidayRowBinding

class QuotesListHolidayAdapter(
    val activity: Activity,
    val list: List<Any>,
    private var mListener: RecyclerViewClickListener? = null
) :
    RecyclerView.Adapter<QuotesListHolidayAdapter.ContentPreviewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ContentPreviewHolder {
        ...
        val qoutesListRowLayoutBinding =
            QoutesListHolidayRowBinding.inflate(layoutInflater!!, parent, false)
...
//        }
    ...
    inner class ContentPreviewHolder(val b: QoutesListHolidayRowBinding) :
