...
class Frames(var catName: String) : Fragment() {
    ...
    private fun setupObservers(categoryName: String) {
        ...
        val framesViewModel : FramesViewModel by lazy { ViewModelProvider(this)[FramesViewModel::class.java] }
        framesViewModel.getCategoryWiseCards(categoryName).observe(viewLifecycleOwner, Observer { resource ->
