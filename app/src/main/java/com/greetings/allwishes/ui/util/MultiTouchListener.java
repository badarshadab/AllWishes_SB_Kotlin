...
//                    Toast.makeText(mContext, "clicked on textview", Toast.LENGTH_SHORT).show();
    ...
    private class ScaleGestureListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(View view, ScaleGestureDetector detector) {
            TransformInfo info = MultiTouchListener.this.new TransformInfo((TransformInfo) null);
            info.deltaScale = MultiTouchListener.this.isScaleEnabled ? detector.getScaleFactor() : 1.0F;
            info.deltaAngle = MultiTouchListener.this.isRotateEnabled ? Vector2D.Companion.getAngle(this.mPrevSpanVector, detector.getCurrentSpanVector()) : 0.0F;
