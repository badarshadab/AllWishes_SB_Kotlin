...
import com.modlueinfotech.allwishesgif.data.model.createCardMode.FontsModel
import com.modlueinfotech.allwishesgif.data.model.createCardMode.GradientModel
import com.google.firebase.ktx.Firebase
import com.google.firebase.storage.StorageReference
import com.google.firebase.storage.ktx.storage
import com.modlueinfotech.allwishesgif.Repo
...
//        categoryPath = stpath
//        stickermutdata?.let { Repo.fetchAllFrames(it, "$stpath/sticker") }
    }
    ...
    private fun getQuotes(catName: String) {
        ...
        val listRef = storage.reference.child(catName + "/quotes")
        listRef.listAll()
